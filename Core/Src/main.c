...
osThreadId LED_Task1Handle;
osThreadId LED_Task2Handle;
...
int main(void)
{
  ...
  osThreadDef(LED_Task, LED_Thread, osPriorityNormal, 0, 128);
  LED_TaskHandle = osThreadCreate(osThread(LED_Task), NULL);

  /* definition and creation of LED_Task1 */
  osThreadDef(LED_Task1, LED_Thread1, osPriorityIdle, 0, 128);
  LED_Task1Handle = osThreadCreate(osThread(LED_Task1), NULL);

  /* definition and creation of LED_Task2 */
  osThreadDef(LED_Task2, LED_Thread2, osPriorityIdle, 0, 128);
  LED_Task2Handle = osThreadCreate(osThread(LED_Task2), NULL);

  /* definition and creation of LED_Task3 */
  osThreadDef(LED_Task3, LED_Thread3, osPriorityIdle, 0, 128);
...
{
  /* USER CODE BEGIN 5 */
						//	uint32_t led_delay = (uint32_t)argument;
  /* Infinite loop */
...
/* USER CODE BEGIN Header_LED_Thread3 */
/**
* @brief Function implementing the LED_Task3 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LED_Thread3 */
void LED_Thread3(void const * argument)
{
  /* USER CODE BEGIN LED_Thread3 */
					//uint32_t led_delay = (uint32_t)argument;
  /* Infinite loop */
    while (1) {
